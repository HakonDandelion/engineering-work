   ...
   return(
       <div className="bg-black/20 backdrop-blur-sm">
           <nav className="grid grid-cols-2 sm:flex justify-between items-center text-white max-w-screen-xl mx-auto">
               ...
               <ul className="hidden sm:flex flex-col sm:gap-8 sm:flex-row peer-checked:flex col-start-1 col-end-3 bg-black/20 backdrop-blur-sm"
                   id="navigation-menu">
                   ...
                   <li>
                       <button onClick={handleLogout} className="hover:bg-fuchsia-600/20 min-h-[3rem] px-4 inline-flex items-center gap-2">
                           <span>Wyloguj</span>
                           <span>+</span>
                       </button>
                   </li>
